<template>
  ...
  <section
    id="manage"
    class="bg-gradient-to-t from-zinc-900 from-70% to-[#5038a0] to-90% h-full border border-red-700"
  >
        ...
        <div class="col-span-1">
          ...
          >
            ...
            <div class="p-6">
              <!-- Upload Dropbox -->
              <div
                class="w-full px-10 py-20 rounded text-center cursor-pointer border border-dashed border-gray-400 text-gray-400 transition duration-500 hover:text-white hover:bg-zinc-500 hover:border-solid"
              >
                ...
                <div>
                  <form>
                    <div class="mb-3">
                      ...
                      <input
                        type="text"
                        class="block w-full py-1.5 px-3 text-gray-800 border border-transparent transition duration-500 focus:outline-none focus:border-white rounded"
