<template>
  <div class="mt-16">
    <!-- Music Header -->
    <section class="w-full z-20 mb-8 text-center text-white relative">
      <div
    ...
    <section class="container mx-auto mt-6">
      <div class="bg-neutral-800 rounded border text-white border-gray-200 relative flex flex-col">
